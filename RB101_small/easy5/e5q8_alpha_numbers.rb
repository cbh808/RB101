...
sorted numerical array elements using hash to retrieve correct values of strings to compare
=end 
...
# note that hash works but not required, could also use an array in lieu of hash
